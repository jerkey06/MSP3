...
execute as @s[tag=ija-a4-mined] at @s unless entity @s[scores={ija-a4-upgrade=1..}] run function ija-one-block:generated/text/manager
execute as @s[scores={ija-a4-cooldown=1}] at @s unless entity @s[tag=ija-a4-mined] unless entity @s[scores={ija-a4-upgrade=1..}] run function ija-one-block:generated/text/manager
