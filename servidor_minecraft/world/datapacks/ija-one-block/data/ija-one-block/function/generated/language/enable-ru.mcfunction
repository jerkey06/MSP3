...
tag @e[tag=ija-a4-block] add ija-a4-lang-ru
...
execute as @e[tag=ija-a4-upgrade-message] run data merge entity @s {"CustomName":"\"Смена через:\""}
execute as @e[scores={ija-a4-party-monster-time-left=1..}] run data merge entity @s {"CustomName":"{\"text\":\"Монстр-Охранник\",\"color\":\"dark_red\"}"}
