...
tag @e[tag=ija-a4-block] add ija-a4-lang-uk
tag @e[tag=ija-a4-block] remove ija-a4-lang-zh_cn
tag @e[tag=ija-a4-block] remove ija-a4-lang-zh_tw
scoreboard objectives modify ija-a4-usermined displayname {"text":"блоки"}
execute as @e[tag=ija-a4-upgrade-message] run data merge entity @s {"CustomName":"\"Оновлення через\""}
execute as @e[scores={ija-a4-party-monster-time-left=1..}] run data merge entity @s {"CustomName":"{\"text\":\"Охоронець-монстр\",\"color\":\"dark_red\"}"}
