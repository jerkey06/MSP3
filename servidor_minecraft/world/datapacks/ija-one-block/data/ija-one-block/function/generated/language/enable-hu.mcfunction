...
tag @e[tag=ija-a4-block] add ija-a4-lang-hu
...
scoreboard objectives modify ija-a4-usermined displayname {"text":"blokkok"}
execute as @e[tag=ija-a4-upgrade-message] run data merge entity @s {"CustomName":"\"Következő fázis:\""}
execute as @e[scores={ija-a4-party-monster-time-left=1..}] run data merge entity @s {"CustomName":"{\"text\":\"Szörny védelmező\",\"color\":\"dark_red\"}"}
