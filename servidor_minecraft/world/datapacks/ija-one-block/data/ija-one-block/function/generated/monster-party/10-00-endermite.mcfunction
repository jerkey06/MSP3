...
execute as @s at @s run summon minecraft:endermite ~ ~1.6 ~ {"Tags":["ija-a4-new-mob"]}
execute as @s at @s run summon minecraft:endermite ~ ~1.6 ~ {"Tags":["ija-a4-new-mob"]}
execute as @s[scores={ija-a4-randomizer=3..}] at @s run summon minecraft:endermite ~ ~1.6 ~ {"Tags":["ija-a4-new-mob"]}
