...
execute as @s at @s run summon minecraft:vindicator ~ ~1.6 ~ {"HandItems":[{"id":"minecraft:iron_axe","count":1},{}],"Tags":["ija-a4-new-mob"]}
execute as @s[scores={ija-a4-randomizer=2..}] at @s run summon minecraft:vindicator ~ ~1.6 ~ {"HandItems":[{"id":"minecraft:iron_axe","count":1},{}],"Tags":["ija-a4-new-mob"]}
