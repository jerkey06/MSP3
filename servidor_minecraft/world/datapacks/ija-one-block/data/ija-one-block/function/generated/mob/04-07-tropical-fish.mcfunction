...
execute as @s[scores={ija-a4-randomizer=2..}] at @s run summon minecraft:tropical_fish ~ ~1.6 ~ {"active_effects":[{"id":"minecraft:resistance","amplifier":5,"duration":300,"show_particles":false}]}
