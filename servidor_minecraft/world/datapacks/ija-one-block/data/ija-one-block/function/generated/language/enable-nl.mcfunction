...
tag @e[tag=ija-a4-block] add ija-a4-lang-nl
...
scoreboard objectives modify ija-a4-usermined displayname {"text":"blokken"}
execute as @e[tag=ija-a4-upgrade-message] run data merge entity @s {"CustomName":"\"Volgende fase in\""}
execute as @e[scores={ija-a4-party-monster-time-left=1..}] run data merge entity @s {"CustomName":"{\"text\":\"Monsterwacht\",\"color\":\"dark_red\"}"}
