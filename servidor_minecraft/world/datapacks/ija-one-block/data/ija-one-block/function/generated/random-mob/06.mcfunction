...
execute as @s[scores={ija-a4-random-mob-type=3..4}] at @s run function ija-one-block:generated/mob/06-01-fox
execute as @s[scores={ija-a4-random-mob-type=5..6}] at @s run function ija-one-block:generated/mob/06-02-armadillo
execute as @s[scores={ija-a4-random-mob-type=7..8}] at @s run function ija-one-block:generated/mob/06-03-villager
